...
class Socket {
  constructor(dispatch, options) {
    ...
    this._debounceRoomUpdateLong = debounce((socketData, socket, apiEndpoint) => {
      this.dispatch(RoomsActions.addSocketList(socket, "Update inspection status or cleaning status", apiEndpoint))
    ...
    this._debounceHost = debounce((socket) => {
      ...
      this.dispatch(RoomsActions.addSocketList(socket, "", ""))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleHotelConfig(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleHotelSettings(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get configuration of hotel", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleFloor(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get hotel floor", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleCalendar(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get room reservation", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleGlitch(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get experiences", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handlePlanning(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get room cleanings", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleNightPlanning(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get room night cleanings", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
      this.dispatch(RoomsActions.planningsFetch());
    });
  }
  ...
  _handleFuturePlanning(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get room future cleanings", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handlePlanningNight(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get room night cleanings", ""))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handlePlanningRunner(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get runner room cleaning", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleTask(socket, data) {
    ...
    InteractionManager.runAfterInteractions(() => {
      ...
      this.dispatch(RoomsActions.addSocketList(socket, "for get hotel tasks", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
    });
  }
  ...
  _handleFutureTask(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get hotel future tasks", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleCustomAction(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      this.dispatch(RoomsActions.addSocketList(socket, "for get asset actions", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
  ...
  _handleRoomMessages(socket) {
    ...
    InteractionManager.runAfterInteractions(() => {
      ...
      this.dispatch(RoomsActions.addSocketList(socket, "for get all messages", socketApiCallConditions))
      this.dispatch(RoomsActions.socketFireTime())
    });
  }
  ...
  _handlePusherConnected(socket) {
    //writeFileIntoLocal(createObjectForAddDataInDataDogSocketFire(socket))
    this.dispatch(RoomsActions.addSocketList(socket, "for internet connected", ""))
    this.dispatch(RoomsActions.socketFireTime())
  ...
  _handlePusherDisconnected(socket) {
    //writeFileIntoLocal(createObjectForAddDataInDataDogSocketFire(socket))
    this.this.dispatch(RoomsActions.addSocketList(socket, "for internet disconnected", ""))
    this.dispatch(RoomsActions.socketFireTime())
