...
class Socket extends Component {
  ...
  activate(userId, hotelGroupId) {
    ...
    channel.bind('hotel_settings', this._handleHotelSettings, this);
    ...
    channel.bind('attendant_nightly_planning', this._handleNightPlanning, this);
    ...
    channel.bind('attendant_planning_future', this._handleFuturePlanning, this);
    // channel.bind('host_planning', this._handlePlanningHost, this);

    channel.bind('hotel_task', this._handleTask, this);
    channel.bind('hotel_future_task', this._handleFutureTask, this);
    ...
    channel.bind('room_message', this._handleRoomMessages, this)
  ...
  _handleRoomUpdate = async (data) => {
    ...
    if (!Array.isArray(configureStore)) {
      ...
      if (subcriptedValue === false) {
        return this.dispatch(RoomsActions.isSocketFireOnUpdateInspection({ isFire: true }))
      }
    }
