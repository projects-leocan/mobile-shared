...
export default function({ apiUrl }) {
  const ASSETS_API = `/Asset/GetListOfAssets`;
  ...
  const CUSTOM_ACTIONS_API = `/Asset/GetListOfAssetActions`;
  ...
  function * fetchCustomActionsFlow() {
    ...
    try {
      ...
      //   return true;
      // }
      yield put(AssetsActions.customActionsSuccess(data , userHotelId))
