...
export default function({ apiUrl }) {  
  ...
  function * watchRoomCleanFailure() {
    console.log('----- watchRoomCleanFailure -----')
  ...
  function * watchRoomResetFailure() {
    console.log('----- watchRoomResetFailure -----')
  ...
  function * watchRoomUpdateFailure() {
    console.log('----- watchRoomUpdateFailure -----')
  ...
  function * watchTaskCreateFailure() {
    console.log('----- watchTaskCreateFailure -----')
  ...
  function * watchTaskUpdateFailure() {
    console.log('----- watchTaskUpdateFailure -----')
  ...
  function * watchTaskReassignFailure() {
    console.log('----- watchTaskReassignFailure -----')
  ...
  function * watchTaskConvertFailure() {
    console.log('----- watchTaskConvertFailure -----')
  ...
  function * watchNotificationCreateFailure() {
    console.log('----- watchNotificationCreateFailure -----')
  ...
  function * watchGlitchUpdateFailure() {
    console.log('----- watchGlitchUpdateFailure -----')
  ...
  function * watchTaskPhotoFailure() {
    console.log('----- watchTaskPhotoFailure -----')
  ...
  function * watchNotificationPhotoFailure() {
    console.log('----- watchNotificationPhotoFailure -----')
  ...
  function * watchLfPhotoFailure() {
    console.log('----- watchLfPhotoFailure -----')
  ...
  function * watchLfSubmitFailure() {
    console.log('----- watchLfSubmitFailure -----')
