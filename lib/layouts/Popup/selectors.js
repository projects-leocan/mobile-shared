...
const getDefaultNotifications = (hotelTasks, userId, usersIndex) => {
    ...
    return !_.isEmpty(hotelTasks) && (task => {
...
const getAttendantNotifications = (hotelTasks, userId, planningIndex, usersIndex) => {
    ...
    return !_.isEmpty(hotelTasks) && hotelTasks?.filter(task => {
        if (task.type !== 'notification') {
            return false;
        }
...
const getPopupNotifications = (userNotifications, usersIndex) => !_.isEmpty(userNotifications) && userNotifications
