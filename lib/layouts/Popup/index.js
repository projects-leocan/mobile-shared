...
import { TaskVideoView, VideoPlayContainer, VideoPlayTouchable, TaskImageView } from "rc-mobile-base/lib/layouts/TaskDetail/styles"
...
class PopupLayout extends Component {
  ...
  render() {
   ...
   // do not show popup for do_raise_accept_popup
    ...
    const loggedInGroupId = this.props.auth.userGroupId;
    const loggedInSubGroupId = this.props.auth.userSubGroupId;
