...
class PopupLayout extends Component {
  ...
  _renderTask(tasks) {
    ...
    return (
      <View
        style={{ justifyContent: 'flex-start', alignItems: 'center', flex: 1, height: '100%', width: '100%' }}>
        <View style={styles.headerContainer}>
          <Text style={styles.headerTitle}>{I18n.t('base.popup.index.new-task')}</Text>
          <Text style={styles.headerSubTitle}>You have assigned a new task</Text>
        ...
        <View style={styles.alertBodyContainer}>
          <Text style={styles.bodyTitle}>Task</Text>
          <Text style={styles.taskTitle}>{asset}</Text>

          <View style={[styles.horizontalContainer, { alignItems: 'center', justifyContent: 'center' }]}>
            <Text style={[styles.bodyTitle, { marginRight: 18 }]}>Add</Text>
            <Text style={[styles.taskTitle, { lineHeight: 35 }]}>04</Text>
          </View>

          <View style={styles.horizontalContainer}>
            <View style={[styles.locationContainer, margin.t30, margin.b10]}>
              <SimpleLineIcons
                name="location-pin"
                size={30}
              />
              <Text style={[styles.bodyTitle, { marginLeft: 12 }]}>{location || "No Location"}</Text>
            </View>

            <View style={[styles.locationRightContainer, margin.t30, margin.b10]}>
              {isGuest ?
                <IcoMoonIcon
                  name="guest-priority"
                  color={red.color}
          ...
          <View style={{ marginVertical: 18 }}>
            ...
            <Text style={styles.commentDescription}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</Text>
          </View>
