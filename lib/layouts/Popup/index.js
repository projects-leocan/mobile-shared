          ...
          <View style={[styles.alertBodyContainer, { padding: 20 }]}>
            ...
            <View style={styles.horizontalContainer}>
              <View style={[styles.locationContainer, margin.t15, margin.b10, flx1]}>
                <View style={{ width: "7%", position: "relative" }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row' }}>
                  ...
                  <Text style={[styles.bodyTitle, { fontSize: 22, marginLeft: 12 }]} adjustsFontSizeToFit>{roomName || "No Location"}</Text>
                  <Text style={[styles.bodyTitle, { fontSize: 22, alignSelf: 'center' }]}>{", " + hotelName}</Text>
                </View>
              </View>
