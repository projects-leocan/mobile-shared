...
class PopupLayout extends Component {
          ...
          <View style={styles.alertBodyContainer}>
            ...
            <View style={styles.horizontalContainer}>
              <View style={[styles.locationContainer, margin.t20, margin.b20, flx1]}>
                ...
                <View style={{ ...margin.t10, ...margin.b10, flex: 1 }}>
  ...
  _renderGlitch(glitch) {
   ...
   async logEvents(tasks, isOpen, notifications, availableTasks, glitches, availableAudits, socketHotelMessages) {
    await analytics().logEvent('Received_Task', {
     tasks: tasks,
     isOpen: isOpen,
     ...
     socketHotelMessages: socketHotelMessages
    })
  }
  ...
  render() {
    ...
    console.log("----- availableTasks ------", JSON.stringify(availableTasks))

    Sentry.captureMessage("AvailableTasks");
    Sentry.captureMessage("isOpen "+ isOpen);

    //  this.logEvents(tasks, isOpen, notifications, availableTasks, glitches, availableAudits, socketHotelMessages);
