...
import { omit, map, flatten } from 'lodash';
      ...
      if (isFindSubGroup) {
        return {
          ...
          userSubGroup: map(get(obj, 'userSubGroup'), function (o) {
            ...
            return { ...o, isSelected: validateIsSelect, subGroupUsers: map(get(o, 'subGroupUsers'), function (o) { return { ...o, isSelected: validateIsSelect } }) }
          }),
        }
      } else {
        return {
