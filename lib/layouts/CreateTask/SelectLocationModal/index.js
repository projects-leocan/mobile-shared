  ...
  <ModalFieldArray
    ...
    renderModal={(toggle, { fields }) => (
      <View style={[flx1, grey.bg,]}>
        ...
        <ModalHeader value={label} onLeftAction={toggle} onRightAction={() => fields.removeAll()} rightIconName="ios-reload-sharp" />
        <SafeAreaView style={[styles.rootContainer,]}>
          ...
          <SelectLocation
            options={options}
            toggle={toggle}
            onPress={(data, isSelected) => isSelected ? deselectLocation(fields, data) : fields.push(data)}
          />
