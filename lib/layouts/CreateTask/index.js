    ...
    if (isAttendantApp) {
      if (displayAssignation && _.isEmpty(finalAssigns)) {
        switch (index) {
          ...
          case 1:
            return <SelectLocation ref={ref => this.SelectLocation = ref} {...taskProps} setLocation={setLocation} getSelectedLocation={getSelectedLocation} tasks={tasks} isInspector={isInspector}/>
          case 2:
