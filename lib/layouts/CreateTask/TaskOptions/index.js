...
import { blueLt, splashBg, white, themeTomato } from 'rc-mobile-base/lib/styles';
...
class TaskOptions extends Component {
  ...
  _renderPriority() {
    ...
    return (
      <View style={styles.itemContainer}>
        <SectionHeading style={{ paddingLeft: 15, marginTop: 15, flex: 1, }}>{I18n.t('base.ubiquitous.priority')}</SectionHeading>
  ...
  _renderMandatory() {
    ...
    return (
      <View style={styles.itemContainer}>
        <SectionHeading style={{ paddingLeft: 15, marginTop: 15, flex: 1 }}>{I18n.t('base.ubiquitous.mandatory-task')}</SectionHeading>
        <View style={styles.optionContainer}>
  ...
  _renderBlocking() {
    ...
    return (
      <View style={styles.itemContainer}>
        <SectionHeading style={{ paddingLeft: 15, marginTop: 15, flex: 1 }}>{I18n.t('base.ubiquitous.blocking-task')}</SectionHeading>
        <View style={styles.optionContainer}>
