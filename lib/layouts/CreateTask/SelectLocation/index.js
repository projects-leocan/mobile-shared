...
export default class SelectLocation extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    const { isSelectAssets, selectedAsset, updatedAssets, selectedAction, isLocationModalOpen } = this.state;
    const { assets, isDisableLiteTasks, customActions } = this.props;
    const { getSelectedLocation, locations } = this.props;

    console.log("yarn add patch-package postinstall-postinstal");
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.rootContainer}>
          <View style={styles.bodySection}>
            ...
            {/* <KeyboardAwareScrollView enableOnAndroid={true} extraHeight={130} contentContainerStyle={{flexGrow:1,paddingBottom:10,}} enableAutomaticScroll={true}> */}
