                            ...
                            <ExtraBackgroundContainer>
                                ...
                                <ExtraPhotoCaptureContainer>
                                    <ExtraPhotoCaptureButton onPress={isStartRecoeding ? this.stopRecording : this.handleTakeVideo}>
                                        {isStartRecoeding ? <Ionicons name="pause-circle" size={36} color="white" /> : <Ionicons name="videocam-sharp" size={36} color="white" />}
                                    </ExtraPhotoCaptureButton>
                                </ExtraPhotoCaptureContainer>

                                <ExtraExitContainer onPress={() => onTakeVideo(false)} >
                                    <Entypo name="cross" size={24} color="black" />
                                </ExtraExitContainer>
                            </ExtraBackgroundContainer>
                        </View>
