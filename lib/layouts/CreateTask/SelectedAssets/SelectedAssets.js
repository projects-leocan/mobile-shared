...
import { View, TouchableOpacity, FlatList, Image, Text, Dimensions, StyleSheet, SafeAreaView } from 'react-native';
...
export default class SelectedAssets extends React.PureComponent {
    constructor(props) {
        super(props);
                            ...
                            <ExtraBackgroundContainer>
                                ...
                                <ExtraPhotoCaptureContainer>
                                    <ExtraPhotoCaptureButton onPress={isStartRecoeding ? this.stopRecording : this.handleTakeVideo}>
                                        {isStartRecoeding ? <Ionicons name="pause-circle" size={42} color="white" /> : <Ionicons name="videocam-sharp" size={36} color="white" />}
                                    </ExtraPhotoCaptureButton>
                                </ExtraPhotoCaptureContainer>
