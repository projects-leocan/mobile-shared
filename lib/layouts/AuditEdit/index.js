...
class AuditEditScene extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <KeyboardAwareView scrollEnabled={true} enableOnAndroid={true} extraHeight={130} contentContainerStyle={{ flexGrow: 1, paddingBottom: 10, }} enableAutomaticScroll={true}>
