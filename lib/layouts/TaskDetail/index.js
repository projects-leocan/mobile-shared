            ...
            <Container>
                ...
                >
                    <SubheaderContainer>
                        ...
                        {get(task, 'category', '') ? <SubheaderStatusTextCopy>{this.capitalize(get(task, 'category', ''))} task</SubheaderStatusTextCopy> : null}
                        ...
                        {get(task, 'timeAgo', '') ? <SubheaderTimeText>{`${task.timeAgo}`}</SubheaderTimeText> : null}
                    </SubheaderContainer>
