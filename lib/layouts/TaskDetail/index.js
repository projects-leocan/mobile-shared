...
class TaskDetail1 extends React.Component {
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: "#fff", paddingBottom: Platform.OS === "android" ? this.props.insets.bottom : 0 }}>
                    ...
                    <Container>
                        ...
                        {isArray(validateAction)
                            ...
                            <InformationContainer>
                                ...
                                {guest_name ? <Item label={`${I18n.t("base.popup.index.guest-name")}`} value={guest_name} /> : null}
