...
import { get, isEmpty, map, filter, compact, orderBy, isArray } from 'lodash';
    ...
    customItem = () => {
        ...
        return (
            <CreateByContainer>
                ...
                <CreatedByName>{task.assigned.label}</CreatedByName>
            </CreateByContainer>
        )
    }
            ...
            <Container>
                ...
                >
                    <SubheaderContainer>
                        ...
                        <SubheaderTimeText>{`${task.timeAgo}`}</SubheaderTimeText>
                    </SubheaderContainer>
                    ...
                    <InformationContainer>
                        ...
                        {!isEmpty(taskImageURLs)
                            ...
                            <FlatList
                                ...
                                ListFooterComponent={() => this.renderTaskImageFooter()}
                            /> : null
                        }
                    ...
                    <InformationContainer>
                        ...
                        {isHaveApartmentInfo && (
                            <>
                                {infoAccess && <Item label={`Information Access`} value={infoAccess} />}
                                {infoGarbage && <Item label={`Information Garbage`} value={infoGarbage} />}
                                {infoParking && <Item label={`Information Parking`} value={infoParking} />}
                                {address && <Item label={`Apartment Address`} value={address} />}
                                {infoImportant && <Item label={`Apartment important`} value={infoImportant} />}
                                {infoOther && <Item label={`Other Apartment information`} value={infoOther} />}
...
const mapStateToProps = (state, props) => {
    const task = currentTask(props.navigation.state.params.task.uuid)(state);
