...
class TaskDetail1 extends React.Component {
    ...
    renderRoomGuestInfo = () => {
        ...
        const anonymizeGuestName = this.props.config?.anonymizeGuestName;
        ...
        return (
            <HorizontalContainer>
                ...
                {isGuestReq ? <ItemLabelDesc style={{ flex: 0.6 }}>{guestName ? isAttendantApp && anonymizeGuestName ? 'no name' : guestName : ''} {checkIn} {checkOut}</ItemLabelDesc> : null}
            </HorizontalContainer>
        )
    }
                    ...
                    <Container>
                        ...
                        {isArray(validateAction)
                            ...
                            <InformationContainer>
                                ...
                                {guest_name ? <Item label={`${I18n.t("base.popup.index.guest-name")}`} value={guest_name ? isAttendantApp && anonymizeGuestName ? 'no name' : guest_name : ''} /> : null}
