...
class RoomRowItem extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity activeOpacity={.1} style={[styles.container,{opacity: name==="1001" || name==="1005" || name==="1011" || name==="1019" || name==="1514" ? 0.4 : 1}]} onPress={() => this.props.roomNavigation(id)}>
        ...
        <View style={[styles.roomIconsContainer]}>
          ...
          {name === "1007" || name === "1010" || name === "1016" || name === "1017" || name==="1001" || name==="1005" || name==="1011" || name==="1019" || name==="1514" ?
          <View style={[styles.breakfastIconView, { backgroundColor: name === "1007" || name === "1010" || name === "1016" || name === "1017" ? '#c1e4c3' : 'white' }]}>
             <MaterialIcons name="free-breakfast" size={18} color={slate.color} />
          </View> :
           <View style={[styles.breakfastIconView]}>
              <Image style={{width:18,height:18}} source={require("../../images/FreeBreakfast.png")}/>
           </View>
          }
        </View>
