...
const ModalContent = ({ activeRoom, dismiss, submit, rooms, cameTobreakfast, allBreakfast, getBreakFast }) => {
    ...
    let isDisableAccept = activeRoomCalender == false ? true : false
    return (
            ...
            <ScrollView scrollEnabled={scrollEnabled} style={{ flexGrow: 1, alignContent: 'flex-start' }} showsVerticalScrollIndicator={false}>
                <View style={[styles.alertBodyContainer]}>
                    ...
                    <View style={styles.numberOfBreakFastView}>
                        <TouchableOpacity style={styles.circleView} onPress={minusBreakFastCount} disabled={activeRoomCalender == false || (breakFastCount == 1) ? true : false}>
                        ...
                        <TouchableOpacity style={styles.circleView} onPress={addBreakFastCount} disabled={activeRoomCalender == false || (breakFastCount == occupants) ? true : false}>
                    ...
                    <View style={styles.borderView}></View>
                    {
                        ...
                        !_.isEmpty(otherProperties) && otherProperties.map((product) => {
                            if (product?.key === "product_name" && (!((product?.value.includes("PDJ")) || (product?.value.includes("ALLCOUNT"))))) {
                                return (
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity disabled={isDisableAccept} style={[styles.confirmBtn]} onPress={() => onAccept()}>
