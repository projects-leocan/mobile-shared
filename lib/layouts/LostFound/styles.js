...
export const RecordButtonOuterContainer = styled.View`
  height: 90;
  width: 90;
  border-radius: 45;
  border-width: 4;
...
export const RecordButtonInnerContainer = styled.TouchableOpacity`
  height: 70;
  width: 70;
  border-radius: 35;
  background-color: ${red.color};
...
export const RecordButtonStopInnerContainer = styled.TouchableOpacity`
  height: 30;
  width: 30;
  border-radius: 8;
  background-color: ${red.color};
