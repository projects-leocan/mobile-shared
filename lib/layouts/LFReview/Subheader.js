...
export default Subheader = ({ searchQuery, updateQuery, isShowAll, updateShow }) => (
  <SubheaderContainer>
    <SearchSubheader
      style={{
        container: { width: Platform.isPad ? 400 : "50%", backgroundColor: 'white', height: 40, marginTop: 10, marginRight: Platform.isPad ? 10 : 5 },
    ...
    />
    <SelectionButton
      label={I18n.t('base.lost-found-review.index.show-only-received').toUpperCase()}
