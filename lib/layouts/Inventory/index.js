        ...
        {activeRoomArea ?
          <View style={[flx1]}>
            <View style={{ width: "100%", flexDirection: "row" }}>
              ...
              <View style={{ width: "10%", backgroundColor: "white",justifyContent:"center" }}>
                <Button style={[{ borderRadius: 0 }, white.bg]} onPress={this._handleNetwork}>
                  <Text style={[{fontSize:30},black.text]}>+</Text>
                </Button>
              </View>
            </View>
