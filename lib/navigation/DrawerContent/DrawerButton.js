  ...
  >
    <View style={{ width: 40, alignItems: 'center' }}>
      { ['clipboard', 'tools', 'bell'].includes(icon) ?
        ...
        :
        icon == 'broom' ? <Image source={require('../../images/cache.png')} style={{width: 30, height: 30, tintColor: slate.color}}/> 
        :
        icon === 'free-breakfast' ? <MaterialIcons name={icon} size={24} color={slate.color}/> 
        :
