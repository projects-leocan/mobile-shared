  ...
  handleClearCache() {
    if (Platform.OS === 'android') {
      ...
      try {
        ...
        ToastAndroid.show('Cache Clear Failed', ToastAndroid.SHORT)
      }
    }
  }

  onDoubleTapEvent = () => {
      this.props.navigation.navigate("SocketHistory");
  };
      ...
      try {
        ...
        return (
          <View style={[styles.container, { padding: -20 }]}>
            ...
            <TouchableOpacity onPress={this.onDoubleTapEvent}>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getCleaning: () => dispatch(RoomsActions.allHotelPlanningsFetch()),
    dispatch
  }
};
