...
const navigationCreate = (scenes, links, params) => {
  ...
  if (MainLayout) {
    MainLayout.navigationOptions = ({ navigation, screenProps }) => ({
      ...
      headerRight: (screenProps.isAttendantApp || screenProps.isRunnerApp) ? <TaskButton tasksLength={screenProps.tasksLength || 0} onPress={() => navigation.navigate("Tasks")} /> : null
    });
  }
