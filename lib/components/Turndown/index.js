          ...
          <View style={styles.container}>
            ...
            <View style={[flexGrow1, { flex: 1 }]}>
              <SectionList
                ...
                renderItem={({ item, index }) => <RoomRow room={item} activateRoom={this._handleActiveRoom} displayUser={displayUser} auth = {this.props.auth} isAttendantApp={this.props.isAttendantApp}/>}
            ...
            <NewModal
              ...
              onRequestClose={this._handleDismissRoom}
            ...
            >
              <ModalContent
                ...
                isAttendantApp={this.props.isAttendantApp}
              // specificRoomUpdate={specificRoomUpdate}
              />
            </NewModal>
