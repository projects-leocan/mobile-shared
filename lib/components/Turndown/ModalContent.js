  ...
  return (
    <View style={[styles.container, flx1]}>
      ...
      <ScrollView>
        ...
        {isDone ?
          <View>
            <TouchableOpacity style={styles.cancelBtn} onPress={() => submit(turndownService && turndownService === "cleaning" ? 'cancel-finish' : '')}>
          ...
          <View>
            ...
            <View style={styles.subBtns}>
              <TouchableOpacity style={[styles.subBtn, margin.r5, { backgroundColor: "#65E5D8" }]} onPress={() => submit('cleaning')}>
                ...
                <Text style={styles.btnText}>{"Start cleaning".toUpperCase()}</Text>
              </TouchableOpacity>
