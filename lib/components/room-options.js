...
class RoomOptions extends Component {
  ...
  _handleGallery = () => {
    this.props.onNavigate('GalleryGrid');
  ...
  _handleMaintenance = () => {
    const { roomId, roomTasks } = this.props;
    this.props.onNavigate('CreateTask', { layout: 'maintenance', type: 'maintenance', selectedRoom: roomId, tasks: roomTasks});
  }

  _handleTask = () => {
    this.props.onNavigate('CreateTask',{tasks: this.props.roomTasks});
  }
  ...
  _handleAudits = () => {
    const { roomId, floorId, buildingId } = this.props;
    this.props.onNavigate('Audits', { roomId: roomId, floorId: floorId, buildingId: buildingId });
  }
