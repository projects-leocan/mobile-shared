    ...
    return (
      <View style={styles.loginRootcontainer}>
        {displayLogin ? <UserLogin {...this.props} /> :
          // <ScrollView testID="hotelLogin" style={styles.loginRootcontainer} scrollEnabled={true}>
            <KeyboardAwareScrollView style={{ flex: 1 }}>
              <View style={styles.hotelContainer}>
                ...
                <View style={styles.bodyContainer}>
                  ...
                  <ScrollView style={styles.PermissionView} showsVerticalScrollIndicator={false}>
