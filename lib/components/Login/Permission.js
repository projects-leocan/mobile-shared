...
import Hotel, { HotelLogin } from 'rc-mobile-base/lib/components/Login/Hotel';
import { F } from 'ramda';
  ...
  render() {
    ...
    return (
      ...
      <SafeAreaView style={{ height: "100%",backgroundColor:"white" }}>
        <View style={styles.permissionRootcontainer}>
          {displayLogin ? <UserLogin {...this.props} /> :
            <View style={styles.hotelPermissionContainer}>
              <View style={styles.permissionheaderContainer}>
              <Text style={[styles.permissionTitle, { lineHeight: 30 }]}>To get started,</Text>
                  <Text style={[styles.permissionTitle,{marginBottom:50}]}>Hopr {appName} needs access to:</Text>
                {/* <Image source={require('../../images/splash_logo.png')} style={styles.logoImg} /> */}
              </View>
              <View style={styles.permissionBodyContainer}>
                  {/* <Text style={[styles.permissionTitle, { lineHeight: 30 }]}>To get started,</Text>
                  <Text style={[styles.permissionTitle,{marginBottom:50}]}>Hopr {appName} needs access to:</Text> */}
