...
export class HotelLogin extends Component {
  ...
  componentDidMount() {
    ...
    if (hotelName) {
      this.props.initialize({ hotel: hotelName });
    }
  }
  ...
  render() {
    const { submitHotelLogin, handleSubmit, appName, error, hotel, hotelGroupname, hotelName } = this.props;
            ...
            <View style={styles.bodyContainer}>
              ...
              {/* <View style={styles.loginActionContainer}>
                <View style={styles.inputFieldContainer}>
                  <View style={[styles.inputFieldCell, { marginRight: 10 }]}>
