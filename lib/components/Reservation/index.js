...
const FlagImage = ({ img }) => {
  return (
    img === "" ? <></> : <Image style={{ height: 30, width: 35, marginHorizontal: 5 }} source={img} />
  )
}

const FlagView = ({ Country }) => {
  if (!_.isEmpty(Country)) {
    if (Country[0].value === "FRANCE") {
      return (
        <FlagImage img={require("../../images/CountryFlags/France.png")} />
      )
    }
    if (Country[0].value === "BELGIQUE") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Belgique.png")} />
      )
    }
    if (Country[0].value === "HONK KONG") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Honkkong.png")} />
      )
    }
    if (Country[0].value === "SENEGAL") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Senegal.png")} />
      )
    }
    if (Country[0].value === "ROYAUME-UNI") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Royaumeuni.png")} />
      )
    }
    if (Country[0].value === "MAROC") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Maroc.png")} />
      )
    }
    if (Country[0].value === "SUISSE") {
      return (
        <FlagImage img={require("../../images/CountryFlags/Suisse.png")} />
      )
    }
  }
  return <></>
