                ...
                renderItem={({ item: inspection, index, section }) => {
                  return (
                    <Inpst
                      ...
                      onChange={(field, value) => !readOnly && onChange(inspection?.question, field, value, index)}
...
class AuditLogic extends React.Component {
  ...
  handleChange = (inspection, field, value, sectionIndex) => {
    console.log('--- handleChange ---')
    console.log(compact(this.state.inspections))
    ...
    setTimeout(() => {
      ...
      // })
      const sectionQuestion = compact(get(inspections[sectionIndex], 'questions', null))
      const sectionSelectedQuestion = get(find(sectionQuestion, function(o){ return get(o, 'question', '') === inspection}), 'responseFormArray', [])
      console.log('--- sectionIndex ---',sectionSelectedQuestion)
      // console.log('--- inspectionIndex ---', inspectionIndex)
