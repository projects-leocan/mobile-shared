...
import { compact, map , first } from 'lodash';
...
const Inspection = ({
  ...
  const questionImageUrls1 = [...questionImageUrls, ...questionImageUrls, ...questionImageUrls]
      ...
      <QuestionWrapper {...props} card={card}>
        <Content card={card}>
          <QuestionWrapperInner>
            ...
            {!isEmpty(compact(questionImageUrls1)) &&
              <>
                <FlatList
                  data={compact(questionImageUrls1)}
                  horizontal
