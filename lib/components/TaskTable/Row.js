...
import VerfiedTasks from 'rc-mobile-base/lib/components/TaskTable/VerfiedStatus';
...
export const Row = ({ index, toggleModal, modals, onNavigateAudit, ...props }) => {
  ...
  return (
    <RowBase index={index}>
      ...
      <View style={[flxCol, flx1]}>
      <Text style={[text.fw700, styles.taskText,{marginLeft:10}]}>
        {roomName}
        </Text>
      </View>
