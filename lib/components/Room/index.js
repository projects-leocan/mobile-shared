...
import {
  ...
  GuestExactStatusLabel, CleaningStatusContainer, PlaceHolderView, CleaningNameContainerInner
} from './styles';
        ...
        if (room.guestStatus === 'da') {
          return (
            // <LocatorProceedImage source={isGuestIn ? require('../../images/locator_proceed_red.png') : require('../../images/locator_proceed.png')} />
             <LocatorProceedImage source={require('../../images/locator_proceed_red.png')} />
            )
        } else {
          // if (!isGuestIn) {
            return (
            ...
            <CleaningNameContainer style={{ alignSelf: 'flex-end', width: '100%' }}>
              {get(room, 'roomPlanning.name')
                ...
                <CleaningNameContainerInner
                  backgroundColor={get(room, 'roomPlanning.cleaningColor', null) + '50'}
                  border={get(room, 'roomPlanning.cleaningColor', null)}>
