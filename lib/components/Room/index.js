  ...
  renderLocatorStatus = (room, isGuestIn) => {
    if (room.guests && room.guests.length) {
      ...
      if (GuestStatus === 'STAY') {
        ...
        return (
          <AntDesign name="arrowright" color={isGuestIn ? red.color : green.color} size={34} style={{ marginRight: 20, textAlign: 'center', alignSelf: 'center' }} />
        )
      } else if (GuestStatus === 'VAC') {
        return (
          <AntDesign name="arrowright" color={green.color} size={34} style={{ marginRight: 20, textAlign: 'center', alignSelf: 'center' }} />
        )
      }
    } else {
      return (
