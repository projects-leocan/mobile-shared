        ...
        return (
          <RoomStatusContainer>
            ...
            <ETAContainer isPriority={isPriority}>
              ...
              <ETAText>{etd && moment.utc(moment(new Date(etd * 1000).toGMTString())).format("hh:mm A")}</ETAText>
            </ETAContainer>
          </RoomStatusContainer>
        )
      }
        ...
        return (
          <RoomStatusContainer>
            ...
            {/* <ETAText>{eta && unixPrettyTime(eta)}</ETAText> */}
              <ETAText>{eta && moment.utc(moment(new Date(eta * 1000).toGMTString())).format("hh:mm A")}</ETAText>
            </ETAContainer>
          </RoomStatusContainer>
        )
      }
