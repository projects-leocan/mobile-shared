...
import {
  ...
  RightCenterContainer, VipContainer, VipText, BedSheetContainer
} from './styles';
...
export default class Room extends React.Component {
  ...
  renderLocatorStatus = (roomGuests, isGuestIn) => {
    const GuestStatus = String(roomGuests).toUpperCase();
    ...
    if (GuestStatus === 'STAY') {
      ...
      return (
        <MaterialCommunityIcons name="arrow-right-bold-circle" color={isGuestIn ? red.color : green.color} size={34} style={{ marginRight: 20, textAlign: 'center', alignSelf: 'center' }} />
      )
    } else if (GuestStatus === 'VAC' || !roomGuests) {
      return (
        <MaterialCommunityIcons name="arrow-right-bold-circle" color={green.color} size={34} style={{ marginRight: 20, textAlign: 'center', alignSelf: 'center' }} />
      )
    }
  }
        ...
        <Container>
          ...
          <RightContainer style={{ alignItems: 'center', justifyContent: 'space-evenly', }}>
            ...
            <CleaningNameContainer style={{ alignSelf: 'flex-end', justifyContent: 'flex-end' }}>
              {this.renderLocatorStatus(room.guestStatus, get(room, 'isGuestIn'))}
            </CleaningNameContainer>
