...
const VipContainer = ({ roomName, vip, source, memberShip, is_baby, serviceGo, groupName }) => (
  <>
    {(vip || ((source && source?.value === "ClubMed" && is_baby && is_baby === 1) || (source?.value === "ClubMed" && memberShip && memberShip?.value !== "UNSUPPORTED TYPE: Null") || (source?.value === "ClubMed" && serviceGo && serviceGo?.value !== "UNSUPPORTED TYPE: Null") || (source?.value === "ClubMed" && groupName && groupName !== "UNSUPPORTED TYPE: Null"))) &&
      <View style={styles.infoRow}>
