...
const VipContainer = ({ roomName, vip, source, memberShip, is_baby, serviceGo }) => (
  <>
    {(vip || ((source && source.value === "ClubMed" && is_baby && is_baby === 1) || (source.value === "ClubMed" && memberShip && memberShip?.value !== "UNSUPPORTED TYPE: Null") || (source.value === "ClubMed" && serviceGo && serviceGo?.value !== "UNSUPPORTED TYPE: Null"))) &&
      <View style={styles.infoRow}>
          ...
          source ?
            source.value === "ClubMed" ?
              <View style={styles.ClubMedView}>
                ...
                {serviceGo?.value !== "UNSUPPORTED TYPE: Null" && <Text style={[styles.pms, { alignSelf: "center" }]}> {serviceGo?.value}</Text>}
