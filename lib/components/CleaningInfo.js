...
const VipContainer = ({ roomName, vip, source, memberShip, is_baby, serviceGo }) => (
  (vip || ((source && source.value === "ClubMed" && is_baby === 1) || (source.value === "ClubMed" && memberShip?.value !== "UNSUPPORTED TYPE: Null") || (source.value === "ClubMed" && serviceGo?.value !== "UNSUPPORTED TYPE: Null"))) &&
  <View style={styles.infoRow}>
