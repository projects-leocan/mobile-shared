...
export const Picture = ({ value, size, round, icon, color, backupStyle, enableLightbox=true }) => {
  ...
  return (
    <Lightbox
      key={value}
      renderContent={() => <Image style={{ height: height / 2 }} resizeMode="contain" source={{ uri: value[0] }} />}
