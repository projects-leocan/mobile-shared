...
export class TaskList extends Component {
  ...
  render() {
    const { tasks, Row = TaskRow, sectionId, isSectionList = true, onPress, onSwipeoutPress, renderTask, renderHeader, isVirtualized, ...props } = this.props;
    ...
    if (isVirtualized) {
      return (
        <SectionList
          ...
          renderSectionHeader={isSectionList ? (renderHeader ? renderHeader : ({ section }) => <SectionHeader key={section.title} value={headerI18n(section.title)} />) : null}
