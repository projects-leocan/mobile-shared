...
export const blueLt = buildColor('#2e4b8d')
export const blue = buildColor('#1d3059')
export const blueDk = buildColor('#1D2F58')
...
export const blue100 = buildColor('#2e4b8d')
export const blue200 = buildColor('#263d73')
export const blue300 = buildColor('#1d3059')
export const blue500 = buildColor('#1D2F58')
...
export const grey600 = buildColor('#f9f9f9')
...
export const splashBg = buildColor('#1D2F58');
export const themeTomato = buildColor('#ef7373');
export const lightPink = buildColor('#fce3e3');
export const lightBlue = buildColor("#dae8fc");
export const lightBlueBorder = buildColor("#b5c9e7");
export const themeBorderColor = buildColor('#cfd4de');
export const activeGreen = buildColor('#9afdaa');
