...
export function hotelRequest(hotel, hotelGroupname) {
  return {
...
export function hotelSuccess({ loginHotelGroup, hotelGroupName, hotelName, images, users }) {
  return {
...
export function userRequest({ hotelGroupname, hotelUsername, username, password }) {
  return {
...
export function getAuthToken({ access_token, refresh_token, expires_in }) {
  return {
...
export function requestUpdateFCMToken() {
  return {
    type: AuthTypes.REQUEST_UPDATE_FCM_TOKEN
  }
}
