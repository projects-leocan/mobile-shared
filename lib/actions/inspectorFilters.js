...
export function updateFloorSelectionValue(backdrop ,selectedFloor ) {
  return {
    type: InspectorFiltersTypes.UPDATE_FLOOR_SELECTION_SAVE_BTN,
    selectedFloor,
    backdrop
  }
}
...
export function updateFloorSectionOperationOnSelection(backdrop ,selectedFloor) {
  return {
    type: InspectorFiltersTypes.UPDATE_FLOOR_SECTION_OPERATION_ON_SELECTION,
    backdrop,
    selectedFloor
  }
}
...
export function updateAttendantFilterStatus(data) {
  return {
    type: InspectorFiltersTypes.UPDATE_ATTENDANT_STATUS_FILTER,
    data
  }
}

export function updateAttendantNightyFilterStatus(data) {
  return {
    type: InspectorFiltersTypes.UPDATE_ATTENDANT_NIGHTY_STATUS_FILTER,
    data
  }
}

export function getSelectedFilters(data ,selected ,selectedFilter) {
  return {
    type: InspectorFiltersTypes.GET_SELECTED_FILTER,
    data,
    selected,
    selectedFilter
  }
...
export default {
  ...
  setRoomType,
  updateAttendantFilterStatus,
  updateAttendantNightyFilterStatus,
  getSelectedFilters
}
