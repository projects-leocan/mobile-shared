  ...
  return {
    ...
    meta: {
      offline: {
        ...
        commit: { type: OutboundTypes.UPDATE_NIGHTY_INSPECTION_STATUS_SUCCESS, meta: { turnDownPayload, endpoint: ROOM_INSPECTION_NIGHTY_UPDATE_API } },
        rollback: { type: OutboundTypes.UPDATE_NIGHTY_INSPECTION_STATUS_FAILED, meta: { turnDownPayload, tapTs, outboundLabel, endpoint: ROOM_INSPECTION_NIGHTY_UPDATE_API } },
      },
      auth: {
        enable: true
      },
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        rollback: { type: OutboundTypes.OUTBOUND_TASK_UPDATE_FAILURE, meta: { uuid, data, outboundLabel, endpoint: TASK_UPDATE_API } },
      },
      auth: {
        enable: true
      },
...
export function taskUpdateBatch(tasks, userHotelId) {
  ...
  // console.log("userHotelId for update task",userHotelId);
  // console.log("tasks for update task",tasks);
  return {
  ...
  return {
    ...
    meta: {
      offline: {
        ...
        commit: { type: OutboundTypes.OUTBOUND_CREATE_AUDIT_INSERT_ROUTE_SUCESS, meta: { endpoint: AUDIT_INSERT_ROUTE_API } },
