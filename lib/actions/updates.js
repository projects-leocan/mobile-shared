...
export function groupedInventoryAssetConsumationUpdate(groupedAssetConsumation) {
  return {
    type: UpdatesTypes.INVENTORY_GROUPED_ASSET_CONSUMATION,
    groupedAssetConsumation
  }
}
...
export default {
  ...
  groupedInventoryAssetConsumationUpdate,
