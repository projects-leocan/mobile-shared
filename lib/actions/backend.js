...
export function futureTasksFetched() {
  return {
    type: BackendTypes.FUTURE_TASKS_FETCHED
  }
}
...
export function futurePlanningsBackend() {
  return {
    type: BackendTypes.FUTURE_PLANNINGS_BACKEND
  }
}
...
export function roomMessagesBackend() {
  return {
    type: BackendTypes.ROOM_MESSAGES_BACKEND
  }
}

export function roomMessageFetched() {
  return {
    type: BackendTypes.ROOM_MESSAGES_FETCHED
  }
}

export function roomInspectionCleanBackend() {
  return {
    type: BackendTypes.ROOM_INSPECTION_CLEAN_BACKEND
  }
}

export function roomInspectionCleanFetched() {
  return {
    type: BackendTypes.ROOM_INSPECTION_CLEAN_FETCHED
  }
}

export function availHotelsTaskBackend() {
  return {
    type: BackendTypes.AVAIL_HOTELS_TASK_BACKEND
  }
}

export function availHotelsTaskFetched() {
  return {
    type: BackendTypes.AVAIL_HOTELS_TASK_FETCHED
  }
}

export function availHotelsRoomsBackend() {
  return {
    type: BackendTypes.AVAIL_HOTELS_ROOM_BACKEND
  }
}

export function availHotelsRoomsFetched() {
  return {
    type: BackendTypes.AVAIL_HOTELS_ROOM_FETCHED
  }
}
...
export default {
  ...
  roomMessagesBackend,
  roomMessageFetched,
  roomInspectionCleanBackend,
  roomInspectionCleanFetched,
  availHotelsTaskBackend,
  availHotelsTaskFetched,
  availHotelsRoomsBackend,
  availHotelsRoomsFetched
}
