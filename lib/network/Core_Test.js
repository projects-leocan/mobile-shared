...
import { INTERVAL_TIME, OFFLINE_INTERVAL_TIME, PING_URL } from './config_Test';
...
class Network_Test {
  ...
  activate = (value) =>{
    console.log("inside activate network_test",value);
    NetInfo.configure({
  ...
  _runOffline = (value) => {
    console.log("_runOffline",parseInt(value.offlineIntervalTime));
    let OFFLINE_INTERVAL_TIME = parseInt(value.offlineIntervalTime)
    clearInterval(this.timer);
    
    this.timer = setInterval(() => {
      this._checkStatus();
      console.log("OFFLINE_INTERVAL_TIME ++++====",OFFLINE_INTERVAL_TIME);
    }, OFFLINE_INTERVAL_TIME);
  }

  _runOnline = (value) => {
    console.log("_runOnline",parseInt(value.intervalTime));
