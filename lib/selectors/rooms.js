...
import sibuetJson from './sibuet.json'
...
export const getGroupCalendar = (hotelCalendar) => groupBy(sibuetJson || [], 'room_id');
...
export const getIndexReservations = (hotelCalendar, messages) => {
  ...
  const groupCalendar = groupBy(sibuetJson || [], 'room_id');
