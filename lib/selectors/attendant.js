...
export const getAttendantPopupTasks = (hotelTasks, hotelRooms, indexedRooms, userId, hotel) => {
...
export const computedAttendantPopupTasks = createSelector(
  [tasksSelector, roomsSelector, computedIndexAttendantRooms, userIdSelector, hotelSelector],
