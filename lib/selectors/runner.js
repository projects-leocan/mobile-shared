...
export const getRunnerPopupTasks = (hotelTasks, hotelRooms, indexedRooms, userId, hotel) => {
...
export const computedRunnerPopupTasks = createSelector(
  [tasksSelector, roomsSelector, computedIndexRunnerRooms, userIdSelector, hotelSelector],
  getRunnerPopupTasks
)