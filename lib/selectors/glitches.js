...
const getActiveGlitch = (hotelGlitches, activeGlitch) => {
  ...
  return find(hotelGlitches, { id: activeGlitch });
}
...
const getInitialValues = activeGlitch => {
  if (!activeGlitch) {
    return {};
  }
...
export const computedGlitchFormInitialValues = createSelector(
  [computedActiveGlitch],
  getInitialValues,
);
