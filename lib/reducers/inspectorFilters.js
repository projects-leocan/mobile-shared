...
const validateFilterStatus = (filterOperation) => {
  try {
    ...
    if (isRoomOperation || isFloorOperation || isFloorSectionOperation || isRoomTypeOperation || cleanerSelectionOperation || roomSearchQuery || isAttendantFilter || isAttendantNightyFilter) {
      return true
    } else {
      return false
    }
